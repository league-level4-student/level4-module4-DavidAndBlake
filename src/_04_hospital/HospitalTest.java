...
//TODO: UNCOMMENT THE TESTS ONE AT A TIME AND TRY TO GET THEM TO PASS. USE ARRAYLISTS OF EACH OF THE ITEMS, TRYING TO GET THEM TO PASS.
...
//
	...
	public void testDoctorsCanOnlyHandle3Patients() throws Exception { // not done
		Doctor testDoctor = new Doctor();
		testDoctor.assignPatient(new Patient());
		testDoctor.assignPatient(new Patient());
		testDoctor.assignPatient(new Patient());
